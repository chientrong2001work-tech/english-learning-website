...
export default function LoginScreen() {
  const { configured, signInWithGoogle, signInWithFacebook, signInWithEmail, signUpWithEmail, sendPhoneCode } =
    useAuth();
      ...
      <div className="w-full max-w-md rounded-3xl border border-brand-100 bg-white p-8 shadow-lg shadow-brand-900/5">
        ...
        <div className="mb-5 flex flex-col gap-3">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-3 rounded-full bg-[#1877F2] px-5 py-3 font-semibold text-white transition hover:bg-[#1465d1] disabled:cursor-not-allowed disabled:opacity-60"
          >
